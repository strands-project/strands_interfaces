...
template_dir = roslib.packages.get_pkg_dir('strands_admin_web_ui') + '/templates'
render = web.template.render(template_dir)
www_prefix = roslib.packages.get_pkg_dir('strands_admin_web_ui') + '/www/'
...
def get_service_button(button_text, service):
    ...
    return str(render.service_button(button_text, service))
